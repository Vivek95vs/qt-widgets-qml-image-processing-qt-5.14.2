...
QT_MOC_LITERAL(1, 9, 12), // "dataReceived"
QT_MOC_LITERAL(2, 22, 0), // ""
QT_MOC_LITERAL(3, 23, 4), // "data"
QT_MOC_LITERAL(4, 28, 23), // "connectionStatusChanged"
QT_MOC_LITERAL(5, 52, 9), // "connected"
QT_MOC_LITERAL(6, 62, 8), // "readData"
QT_MOC_LITERAL(7, 71, 20), // "onSocketStateChanged"
QT_MOC_LITERAL(8, 92, 28), // "QAbstractSocket::SocketState"
QT_MOC_LITERAL(9, 121, 5) // "state"

    },
    "MyServer\0dataReceived\0\0data\0"
    "connectionStatusChanged\0connected\0"
    "readData\0onSocketStateChanged\0"
...
void MyServer::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 3: _t->onSocketStateChanged((*reinterpret_cast< QAbstractSocket::SocketState(*)>(_a[1]))); break;
        default: ;
        }
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&MyServer::dataReceived)) {
                *result = 0;
                return;
            }
        }
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&MyServer::connectionStatusChanged)) {
                *result = 1;
                return;
            }
        }
...
// SIGNAL 0
void MyServer::dataReceived(QByteArray _t1)
{
...
// SIGNAL 1
void MyServer::connectionStatusChanged(bool _t1)
{
    void *_a[] = { nullptr, const_cast<void*>(reinterpret_cast<const void*>(std::addressof(_t1))) };
