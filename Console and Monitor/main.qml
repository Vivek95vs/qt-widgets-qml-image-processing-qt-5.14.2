...
Item {
    ...
    QtObject {
        Component.onCompleted: {
            ...
            console.log("Screen 1:", screens[0].name, "size:", screens[0].width + "x" + screens[0].height);
            if (screens.length > 1) {
                console.log("Screen 2:", screens[1].name, "size:", screens[1].width + "x" + screens[1].height);
            }
            ...
            if (screens.length > 1) {
                ...
                console.log("Only one display detected — Screen2 will not open.");
            }
        }
    }
}
