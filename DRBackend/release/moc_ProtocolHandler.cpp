...
QT_MOC_LITERAL(1, 16, 12), // "commandReady"
QT_MOC_LITERAL(2, 29, 0), // ""
QT_MOC_LITERAL(3, 30, 7), // "command"
QT_MOC_LITERAL(4, 38, 14), // "feedbackParsed"
QT_MOC_LITERAL(5, 53, 4), // "data"
QT_MOC_LITERAL(6, 58, 19) // "processIncomingData"

    },
    "ProtocolHandler\0commandReady\0\0command\0"
    "feedbackParsed\0data\0processIncomingData"
};
...
void ProtocolHandler::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->commandReady((*reinterpret_cast< const QByteArray(*)>(_a[1]))); break;
        case 1: _t->feedbackParsed((*reinterpret_cast< const QVariantMap(*)>(_a[1]))); break;
        case 2: _t->processIncomingData((*reinterpret_cast< const QByteArray(*)>(_a[1]))); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (ProtocolHandler::*)(const QByteArray & );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&ProtocolHandler::commandReady)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (ProtocolHandler::*)(const QVariantMap & );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&ProtocolHandler::feedbackParsed)) {
                *result = 1;
                return;
            }
        }
...
// SIGNAL 0
void ProtocolHandler::commandReady(const QByteArray & _t1)
{
...
// SIGNAL 1
void ProtocolHandler::feedbackParsed(const QVariantMap & _t1)
{
    void *_a[] = { nullptr, const_cast<void*>(reinterpret_cast<const void*>(std::addressof(_t1))) };
