                    ...
                    Row {
                        ...
                        Rectangle {
                            ...
                            MouseArea {
                                ...
                                onClicked: {
//                                    validateuser = dataProvider.validateUser(usertextInput.text, passwordtextInput.text)
//                                    if (validateuser > 0)
//                                    {
//                                        if (validateuser === 1)
//                                        {
//                                            if(serverController.backendconnection===true)
//                                            {
//                                                login.close()
//                                                mainLoader.source = "Worklist.qml"
//                                                serverController.senddatatobackend(4)
//                                                console.log("Authorization Confirm clicked")
//                                                if(!dataProvider.loadHomingStatus())
//                                                {
//                                                    errormessages.showCritical("Homing Status Warning","Some modules have not been homed today.\nPlease perform homing before proceeding.")
//                                                }
//                                            }
//                                            else
//                                            {
//                                                errormessages.showCritical("Warning","Backend not connected")
//                                            }
//                                        }
//                                        else if (validateuser === 2)
//                                        {
//                                            userunderline.color = "white"
//                                            passwordunderline.color = "white"
//                                            invalidcredentials.text = "User Inactive"
